...
export default function Skills() {
  const skillCategories = [
    ...
    },
    {
      ...
      skills: ["React", "Next.js", "Git", "GitHub", "Flask", "Jinja", "Prisma", "MySQL", "PostgreSQL"],
    ...
    <section className="relative py-20 px-4">
      ...
      <div className="relative max-w-6xl mx-auto">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <span className={subtitle() + " text-violet-400 uppercase tracking-wider text-sm font-semibold"}>MY ABILITIES</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {skillCategories.map((category, index) => (
            ...
            >
              ...
              <div className={`absolute -inset-0.5 bg-gradient-to-r ${category.gradient} rounded-xl opacity-0 group-hover:opacity-100 blur transition-opacity duration-500`}></div>
              ...
              <div className="relative bg-gray-900/80 backdrop-blur-sm p-8 rounded-xl border border-gray-800 hover:border-violet-500/50 transition-all duration-300 h-full">
                <div className="mb-6">
                  ...
                  <div className={`h-1 w-12 bg-gradient-to-r ${category.gradient} rounded-full mt-2`}></div>
                </div>
                ...
                <ul className="space-y-3">
                  {category.skills.map((skill, i) => (
                    <motion.li
                      ...
                      viewport={{ once: true }}
                    >
                      <span className="w-2 h-2 bg-violet-400 rounded-full group-hover/item:scale-125 transition-transform duration-200"></span>

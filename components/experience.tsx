...
const roles: Role[] = [
  {
    ...
    summary:
      "Full-stack React app with a multi-modal RAG pipeline for automated lab reporting",
    location: "Davis, CA",
  ...
  },
  {
    ...
    summary:
      "Built the internal project-management platform and SQLite→PostgreSQL data pipelines",
    location: "Davis, CA",
    date: "Feb – Jun 2025",
    logo: persist,
  },

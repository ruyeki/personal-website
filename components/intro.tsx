...
export default function Intro() {
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-violet-500/10 via-transparent to-purple-500/10 animate-gradient"></div>
    ...
    <div className="flex min-h-screen items-center justify-center">
      <div className="inline-block max-w-4xl text-center -mt-40 px-6">
        ...
        >
          ...
          <a href="/Ryan%20Uyeki's%20Resume.pdf" download className="group">
